...
function Aside({ isDrawerOpen }) {
  ...
  const navContent = [
    ...
    {
      title: "الحسابات",
      svg_path: "M16 7a4 4 0 11-8 0 4 4 0 018 0zM12 14a7 7 0 00-7 7h14a7 7 0 00-7-7z",
      path: "/accounts",
    },
    {
    ...
    {
      title: "الاعلانات",
      svg_path: "M14 3a1 1 0 011 1v1h1a1 1 0 011 1v12a1 1 0 01-1 1H5a1 1 0 01-1-1V6a1 1 0 011-1h1V4a1 1 0 011-1h7zm-3 8a3 3 0 100 6 3 3 0 000-6zm-1 3a1 1 0 112 0 1 1 0 01-2 0zm5-9h-1V5h-6v2H9v1h1v1H7v9h10V7h-1V6h1V5h-1V4h1v1z",
      path: "/ads",
    },
    {
      title: "التقارير",
      svg_path: "M9 17v-2m3 2v-4m3 4v-6m2 10H7a2 2 0 01-2-2V5a2 2 0 012-2h5.586a1 1 0 01.707.293l5.414 5.414a1 1 0 01.293.707V19a2 2 0 01-2 2z",
      path: "/reports",
      subItems: [
        {
          title: "تقارير مالية",
    ...
    {
      title: "الدعم الفني",
      svg_path: "M18.364 5.636l-3.536 3.536m0 5.656l3.536 3.536M9.172 9.172L5.636 5.636m3.536 9.192l-3.536 3.536M21 12a9 9 0 11-18 0 9 9 0 0118 0zm-5 0a4 4 0 11-8 0 4 4 0 018 0z",
      path: "/tech-support",
    },
    {
      title: "الاعدادات",
      svg_path: "M10.325 4.317c.426-1.756 2.924-1.756 3.35 0a1.724 1.724 0 002.573 1.066c1.543-.94 3.31.826 2.37 2.37a1.724 1.724 0 001.065 2.572c1.756.426 1.756 2.924 0 3.35a1.724 1.724 0 00-1.066 2.573c.94 1.543-.826 3.31-2.37 2.37a1.724 1.724 0 00-2.572 1.065c-.426 1.756-2.924 1.756-3.35 0a1.724 1.724 0 00-2.573-1.066c-1.543.94-3.31-.826-2.37-2.37a1.724 1.724 0 00-1.065-2.572c-1.756-.426-1.756-2.924 0-3.35a1.724 1.724 0 001.066-2.573c-.94-1.543.826-3.31 2.37-2.37.996.608 2.296.07 2.572-1.065z",
      path: "/settings",
    },
  ];
      ...
      <div className="p-4 h-full flex flex-col">
          ...
          <ul className="space-y-1">
            {navContent.map((nav) => {
              const isActive = currentPath === nav.path || 
                (nav.subItems && nav.subItems.some(item => currentPath === item.path));
        ...
        <div className="mt-auto">
          ...
          >
            ...
            {isDrawerOpen && (
              <span className="mr-3 whitespace-nowrap text-[rgb(var(--error))]" onClick={(e)=> handleLogout(e)}>
                تسجيل الخروج
              </span>
            )}
          </a>
